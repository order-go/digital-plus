...
const ProductDetail=({product,onAddToCart}: {product: Product,onAddToCart: () => void}) => {
    return (
        <div className="flex flex-col justify-between items-center w-72 h-auto p-5 border-2 border-primary text-textPrimary rounded-lg">
            <div>
            ...
            <Button color="bg-primary" label="Agregar pedido" onClick={onAddToCart} />
        </div>
    );
};
