    ...
    return (
        <>
            <div className="fixed inset-0 flex items-center justify-center z-50">
                <div className="bg-tertiary border-2 border-primary rounded-lg p-6 w-72 shadow-lg">
                    <label className="flex flex-col space-y-2">
                        <h2 className="text-xl font-bold mb-4 text-textPrimary">Seleccione la región</h2>
                        <select
                            value={selectedDelivery}
                            onChange={handleDeliveryChange}
                            className="form-select mt-1 block w-full outline-none bg-tertiary text-textSecundary border-primary border-2 shadow-sm focus:ring-opacity-50"
                        >
                            <option className='text-primary' value=''>Ninguno</option>
                    ...
                    <div className="mt-4 flex justify-end space-x-2">
                        <button onClick={onClose} className="px-4 py-2 bg-red-500 text-white rounded-md active:bg-primary">Cerrar</button>
                    </div>
                </div>
            </div>
