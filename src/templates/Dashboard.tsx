...
const Dashboard=() => {
  ...
  function quitarAcentos(cadena: string): string {
    ...
    for(let i: number=0;i<acentos.length;i++) {
  ...
  return (
    <section className='flex bg-tertiary flex-col justify-center items-center pt-20 '>
      <div className='flex flex-row justify-between items-center gap-8'>
        <InputFilter onSearch={handleSearch} />
        <FilterCategories onFilter={setFilteredCategories} />
      </div>
      <div className='bg-tertiary w-full flex flex-col items-center justify-center'>
